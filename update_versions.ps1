...
foreach ($file in $files) {
    ...
    # Update style.css?v=54 -> v55
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=55'
    
    # Update main.js?v=47 -> v48
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=48'
