...
foreach ($file in $files) {
    ...
    # Update style.css?v=70 -> v71
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=71'
    
    # Update main.js?v=70 -> v71
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=71'
