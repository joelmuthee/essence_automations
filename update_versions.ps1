...
foreach ($file in $files) {
    ...
    # Update style.css?v=57 -> v58
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=58'
    
    # Update main.js?v=50 -> v51
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=51'
