...
foreach ($file in $files) {
    ...
    # Update style.css?v=58 -> v59
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=59'
    
    # Update main.js?v=51 -> v52
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=52'
