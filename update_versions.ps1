...
foreach ($file in $files) {
    ...
    # Update style.css?v=55 -> v56
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=56'
    
    # Update main.js?v=48 -> v49
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=49'
