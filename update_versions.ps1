...
foreach ($file in $files) {
    ...
    # Update style.css?v=68 -> v70
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=70'
    
    # Update main.js?v=62 -> v70
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=70'
