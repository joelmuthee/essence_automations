...
foreach ($file in $files) {
    ...
    # Update style.css?v=34 -> v35
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=35'
    
    # Update main.js?v=27 -> v28
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=28'
