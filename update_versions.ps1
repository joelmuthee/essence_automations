...
foreach ($file in $files) {
    ...
    # Update style.css?v=67 -> v68
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=68'
    
    # Update main.js?v=61 -> v62
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=62'
