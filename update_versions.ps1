...
foreach ($file in $files) {
    ...
    # Update style.css?v=65 -> v66
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=66'
    
    # Update main.js?v=58 -> v59
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=59'
