...
foreach ($file in $files) {
    ...
    # Update style.css?v=31 -> v=32
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=32'
    
    # Update main.js?v=24 -> v=25
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=25'
