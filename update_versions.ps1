...
foreach ($file in $files) {
    ...
    # Update style.css?v=33 -> v34
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=34'
    
    # Update main.js?v=26 -> v27
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=27'
