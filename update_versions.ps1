...
foreach ($file in $files) {
    ...
    # Update style.css?v=35 -> v36
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=36'
    
    # Update main.js?v=28 -> v29
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=29'
