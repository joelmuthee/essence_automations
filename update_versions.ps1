...
foreach ($file in $files) {
    ...
    # Update style.css?v=32 -> v33
    $newContent = $content -replace 'style\.css\?v=\d+', 'style.css?v=33'
    
    # Update main.js?v=25 -> v26
    $newContent = $newContent -replace 'main\.js\?v=\d+', 'main.js?v=26'
